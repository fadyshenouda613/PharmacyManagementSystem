...
public class Agent extends JFrame {
	...
	public Agent() {
		...
		JLabel lblNewLabel_2 = new JLabel("MANAGE AGENTS");
		...
		lblNewLabel_1_1_1.setBounds(0, 144, 38, 20);
		...
		lblNewLabel_1_2_1_1.setBounds(424, 142, 72, 20);
		...
		comboBox.setBounds(541, 86, 145, 24);
		...
		JLabel lblNewLabel_3 = new JLabel("AGENTS LIST");
		...
		comboBox_1.setBounds(541, 144, 145, 22);
